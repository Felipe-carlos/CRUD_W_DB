...
def conectar():
    ...
    """
    try:
        conn = sqlite3.connect('psqlite3.felipe')
...
def atualizar():
    ...
    def atualizar():
        ...
        query = f"UPDATE produtos SET {', '.join(atualizacoes)} WHERE id = ?"

        try:
            print(query,tuple(valores))
